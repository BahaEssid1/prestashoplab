...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.0.0', 'C:\\MAMP\\htdocs\\prestashop', false);
    }
    ...
    {
        return $container->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\MAMP\\htdocs\\prestashop/var/cache/prod\\/localization');
    }
    ...
    protected static function getDotEnvLayerService($container, $lazyLoad = true)
    {
        ...
        return ($lazyLoad->__construct(($container->services['prestashop.adapter.environment'] ??= new \PrestaShop\PrestaShop\Adapter\Environment(false, 'prod', 'front')), 'C:\\MAMP\\htdocs\\prestashop') && false ?: $lazyLoad);
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['C:\\MAMP\\htdocs\\prestashop\\src\\PrestaShopBundle\\Entity']), 'PrestaShop');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['C:\\MAMP\\htdocs\\prestashop\\modules\\productcomments\\src\\Entity']), 'PrestaShop\\Module\\ProductComment\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['C:\\MAMP\\htdocs\\prestashop\\modules\\ps_accounts\\src\\Entity']), 'PrestaShop\\Module\\PsAccounts\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['C:\\MAMP\\htdocs\\prestashop\\modules\\ps_checkout\\src\\Entity']), 'PrestaShop\\Module\\PrestashopCheckout\\Entity');
        ...
        $instance->setProxyDir('C:\\MAMP\\htdocs\\prestashop/var/cache/prod\\/doctrine/orm/Proxies');
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.app_id' => 'front',
            'kernel.cache_dir' => 'C:\\MAMP\\htdocs\\prestashop/var/cache/prod\\',
            ...
            'ps_cache_dir' => 'C:\\MAMP\\htdocs\\prestashop/var/cache/prod\\',
            ...
            'doctrine.orm.proxy_dir' => 'C:\\MAMP\\htdocs\\prestashop/var/cache/prod\\/doctrine/orm/Proxies',
