<?php
/* Smarty version 4.5.5, created on 2025-09-25 18:22:18
  from 'module:ps_imagesliderviewstemplateshookslider.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68d57a4a96c192_82559328',
...
function content_68d57a4a96c192_82559328 (Smarty_Internal_Template $_smarty_tpl) {
?>
  <div id="carousel" data-ride="carousel" class="carousel slide" data-interval="5000" data-wrap="true" data-pause="hover" data-touch="true">
    ...
    <ul class="carousel-inner" role="listbox" aria-label="Carousel container">
          ...
          <a href="https://www.prestashop-project.org">            <figure>
              <img src="http://localhost/prestashop/modules/ps_imageslider/images/sample-1_rtl.jpg" alt="sample-1" loading="lazy" width="1110" height="340">
          ...
          <a href="https://www.prestashop-project.org">            <figure>
              <img src="http://localhost/prestashop/modules/ps_imageslider/images/sample-2_rtl.jpg" alt="sample-2" loading="lazy" width="1110" height="340">
                              <figcaption class="caption">
              ...
              <li class="carousel-item " role="option" aria-hidden="true">
          <a href="https://www.prestashop-project.org">            <figure>
              <img src="http://localhost/prestashop/modules/ps_imageslider/images/sample-3_rtl.jpg" alt="sample-3" loading="lazy" width="1110" height="340">
                              <figcaption class="caption">
