...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.0.0', 'C:\\MAMP\\htdocs\\prestashop', true);
    }
    ...
    {
        return $container->services['PrestaShop\\Module\\PrestashopCheckout\\Logger\\LoggerDirectory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('9.0.0', 'C:\\MAMP\\htdocs\\prestashop');
    }
    ...
    {
        return $container->services['prestashop.adapter.module.repository.module_repository'] = new \PrestaShop\PrestaShop\Adapter\Module\Repository\ModuleRepository('C:\\MAMP\\htdocs\\prestashop', 'C:\\MAMP\\htdocs\\prestashop/modules/');
    }
    ...
    {
        return $container->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\MAMP\\htdocs\\prestashop/var/cache/dev\\/localization');
    }
    ...
    {
        return $container->services['prestashop.translation.translator_language_loader'] = new \PrestaShopBundle\Translation\TranslatorLanguageLoader(($container->services['prestashop.adapter.module.repository.module_repository'] ??= new \PrestaShop\PrestaShop\Adapter\Module\Repository\ModuleRepository('C:\\MAMP\\htdocs\\prestashop', 'C:\\MAMP\\htdocs\\prestashop/modules/')));
    }
    ...
    {
        return $container->services['ps_checkout.cache.filesystem.paypal.capture'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('paypal-capture', 3600, ($container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] ??= new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.0.0', 'C:\\MAMP\\htdocs\\prestashop', true))->getPath());
    }
    ...
    {
        return $container->services['ps_checkout.cache.filesystem.paypal.order'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('paypal-orders', 3600, ($container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] ??= new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.0.0', 'C:\\MAMP\\htdocs\\prestashop', true))->getPath());
    }
    ...
    protected static function getDotEnvLayerService($container, $lazyLoad = true)
    {
        ...
        return ($lazyLoad->__construct(($container->services['prestashop.adapter.environment'] ??= new \PrestaShop\PrestaShop\Adapter\Environment(true, 'dev', 'front')), 'C:\\MAMP\\htdocs\\prestashop') && false ?: $lazyLoad);
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($b, ['C:\\MAMP\\htdocs\\prestashop\\src\\PrestaShopBundle\\Entity']), 'PrestaShop');
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($b, ['C:\\MAMP\\htdocs\\prestashop\\modules\\productcomments\\src\\Entity']), 'PrestaShop\\Module\\ProductComment\\Entity');
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($b, ['C:\\MAMP\\htdocs\\prestashop\\modules\\ps_accounts\\src\\Entity']), 'PrestaShop\\Module\\PsAccounts\\Entity');
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($b, ['C:\\MAMP\\htdocs\\prestashop\\modules\\ps_checkout\\src\\Entity']), 'PrestaShop\\Module\\PrestashopCheckout\\Entity');
        ...
        $instance->setProxyDir('C:\\MAMP\\htdocs\\prestashop/var/cache/dev\\/doctrine/orm/Proxies');
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.app_id' => 'front',
            'kernel.cache_dir' => 'C:\\MAMP\\htdocs\\prestashop/var/cache/dev\\',
            'kernel.active_modules' => [
                ...
                22 => 'ps_categoryproducts',
                23 => 'ps_categorytree',
                24 => 'ps_checkout',
                25 => 'ps_checkpayment',
                26 => 'ps_classic_edition',
                27 => 'ps_contactinfo',
                28 => 'ps_crossselling',
                29 => 'ps_currencyselector',
                30 => 'ps_customeraccountlinks',
                31 => 'ps_customersignin',
                32 => 'ps_customtext',
                33 => 'ps_dataprivacy',
                34 => 'ps_distributionapiclient',
                35 => 'ps_emailalerts',
                ...
                41 => 'ps_featuredproducts',
                42 => 'ps_googleanalytics',
                43 => 'ps_imageslider',
                44 => 'ps_languageselector',
                45 => 'ps_linklist',
                46 => 'ps_mainmenu',
                47 => 'ps_mbo',
                48 => 'ps_newproducts',
            ...
            'prestashop.module_dir' => 'C:\\MAMP\\htdocs\\prestashop/modules/',
            'kernel.project_dir' => 'C:\\MAMP\\htdocs\\prestashop',
            'ps_cache_dir' => 'C:\\MAMP\\htdocs\\prestashop/var/cache/dev\\',
            ...
            'doctrine.orm.proxy_dir' => 'C:\\MAMP\\htdocs\\prestashop/var/cache/dev\\/doctrine/orm/Proxies',
